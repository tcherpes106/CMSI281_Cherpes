 ...
 *  Purpose       :  Try to implement a classic memory game in java
 *  @author       :  Timothy and Alex
 *  Date written  :  11/10/2020
 *  Description   :  This program tests a users memory skills by showing them characters and asking them to repeat it back
 *  Warnings      :  None
 *  Exceptions    :  None
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
public class Simon{
  ...
  public static void main(String[] args){
    ...
    System.out.println("Please type all responses with the matching case!\n");
    while (play){
      ...
      if (game.arrayCompare(turn,response)){
        System.out.println("Great job... Onto the next letter!");
        turn++;
      }
      else {
